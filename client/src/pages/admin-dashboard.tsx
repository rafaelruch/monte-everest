...
const availableIcons = [
  ...
  { name: "Scissors", icon: Scissors, value: "Scissors" },
  ...
  { name: "Scale", icon: Scale, value: "Scale" },
                        ...
                        <FormControl>
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3 p-3 border rounded-lg bg-gray-50">
                              <div className="flex items-center justify-center w-10 h-10 rounded-md bg-white border">
                                {field.value && availableIcons.find(icon => icon.value === field.value) ? (
                                  React.createElement(availableIcons.find(icon => icon.value === field.value)!.icon, { className: "h-6 w-6 text-gray-700" })
                                ) : (
                              ...
                              <div>
                                <div className="font-medium text-sm">
                                  {field.value && availableIcons.find(icon => icon.value === field.value)
                                    ? availableIcons.find(icon => icon.value === field.value)!.name
                                    : "Selecione um ícone"
                                  }
                                </div>
                                <div className="text-xs text-gray-500">
                                  {field.value ? "Ícone selecionado" : "Nenhum ícone selecionado"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="border rounded-lg p-4">
                              <div className="grid grid-cols-8 gap-2 max-h-48 overflow-y-auto">
                                {availableIcons.map((iconData) => {
                                  ...
                                  const isSelected = field.value === iconData.value;
                                  return (
                                    <button
                                      key={iconData.value}
                                      type="button"
                                      onClick={() => field.onChange(iconData.value)}
                                      className={cn(
                                        "group relative p-3 rounded-lg border-2 transition-all duration-200 flex flex-col items-center gap-1 hover:shadow-sm",
                                        isSelected
                                    ...
                                    >
                                      <IconComponent className={cn(
                                        ...
                                        isSelected ? "text-blue-600" : "text-gray-600 group-hover:text-gray-700"
                                      )} />
                                      <span className={cn(
