...
export default function Ranking() {
  ...
  const rankingsUrl = `/api/rankings?categoryId=${selectedCategory}&page=${page}&limit=${limit}`;
  ...
  const pageTitle = selectedCategoryName 
    ? `Melhores ${selectedCategoryName} | Monte Everest`
    : "Ranking de Profissionais | Monte Everest";

  const pageDescription = selectedCategoryName
    ? `Encontre os melhores profissionais de ${selectedCategoryName} avaliados pelos nossos clientes. Veja avaliações, notas e contrate com confiança.`
    : "Descubra os melhores profissionais avaliados pelos nossos clientes em cada categoria. Rankings baseados em avaliações reais.";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://monteeverest.com.br/ranking" />
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center mb-10">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Ranking de Profissionais</h1>
            </div>
